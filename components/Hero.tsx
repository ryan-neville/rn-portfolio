...
export default function Hero() {
  return (
    ...
    >
      {/* Layered dark overlay — light at top, heavy at bottom to blend into site */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/55 to-[#0d1117]" />
      {/* Warm golden vignette from left (where sun is) */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto px-6">
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-slate-300 mb-5 font-light max-w-lg drop-shadow"
        >
        ...
        <motion.div
          ...
          className="flex items-center gap-2 mb-10 text-slate-400 text-sm"
        >
        ...
        >
          <a
            ...
            className="flex items-center gap-2 px-7 py-3.5 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full text-white font-semibold text-sm hover:opacity-90 transition-all duration-200 hover:scale-105 hover:shadow-xl hover:shadow-amber-500/30"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-7 py-3.5 glass border border-white/20 rounded-full text-white font-semibold text-sm hover:border-sky-400/50 hover:bg-sky-400/10 transition-all duration-200 hover:scale-105"
          >
            <Github size={15} />
            GitHub
          </a>
