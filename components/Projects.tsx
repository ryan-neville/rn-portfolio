...
function ProjectCard({ project, index, isInView }: { project: Project; index: number; isInView: boolean }) {
  ...
  return (
    <motion.article
      ...
      className={`group relative glass border border-white/8 hover:border-amber-400/30 rounded-2xl p-5 sm:p-7 md:p-8 transition-all duration-300 hover:shadow-xl ${project.glow} focus-within:border-amber-400/40`}
    >
      {/* Header */}
...
export default function Projects() {
  ...
  return (
    <section id="projects" ref={ref} className="relative py-16 md:py-24 lg:py-28 bg-[#0d1117]">
      {/* Background */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-24 bg-gradient-to-b from-sky-400/40 to-transparent" />
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-amber-500/4 rounded-full blur-[120px] pointer-events-none" />
